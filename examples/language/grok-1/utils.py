...
def get_default_parser():
    ...
    parser.add_argument("--top_k", type=int, default=20, help="Set top_k value for top-k-filtering")
    parser.add_argument("--top_p", type=float, default=0.5, help="Set top_p value for generation")
    return parser
